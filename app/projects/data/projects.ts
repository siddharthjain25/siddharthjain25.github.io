...
export const projects: Project[] = [
  {
    title: "Blog App",
    description:
      "A real-time blog platform for creating and sharing posts with unique URLs and analytics.",
  ...
  },
  {
    title: "Obsidian Pass",
    description:
      "A secure password manager that stores encrypted passwords and account details.",

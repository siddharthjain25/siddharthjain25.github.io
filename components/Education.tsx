...
const educationData = [
  ...
  },
  {
    ...
    period: "2021 - 2025",
    description: "Pursuing B.Tech in Computer Science with specialization in Software Engineering",
    skills: ["Algorithms", "Data Structures", "Operating System", "Networking", "DBMS", "Web Development"],
    progress: 100,
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  >
                    <Card
                      className="relative bg-gradient-to-br from-secondary/50 to-secondary/30 backdrop-blur-xl border border-primary/20 hover:border-primary/50 transition-all duration-500 overflow-hidden group shadow-xl hover:shadow-2xl hover:shadow-primary/20"
                    >
                      {/* Card glow effect */}
                      ...
                      <div className="p-8 space-y-6 relative z-10">
                        ...
                        <div className="space-y-3">
                          <div className={`flex items-center gap-2 text-sm font-mono text-muted-foreground uppercase tracking-wider ${isLeft ? "md:justify-end" : ""}`}>
                          ...
                          <div className={`flex flex-wrap gap-2 ${isLeft ? "md:justify-end" : ""}`}>
                            {edu.skills.map((skill, skillIndex) => (
                              <motion.span
                                ...
                                transition={{ delay: index * 0.2 + skillIndex * 0.05 + 0.3 }}
                                viewport={{ once: true }}
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center justify-between text-xs font-mono text-muted-foreground">
                            ...
                            <span className="text-primary font-bold">{edu.progress}%</span>
                          </div>
                ...
                <div className={`hidden md:block ${isLeft ? "" : "md:col-start-1"}`} />
              </motion.div>
            );
          })}
        </div>
        ...
        >
          <div className="inline-flex items-center gap-4 px-6 py-3 bg-gradient-to-r from-primary/10 via-primary/20 to-primary/10 border border-primary/30 rounded-full">
            ...
            <span className="font-mono text-sm">
              <span className="text-primary font-bold">{educationData.length}</span> Educational Milestones Achieved
            </span>
          </div>
        </motion.div>
      </div>

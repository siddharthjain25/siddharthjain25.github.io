...
const profile = {
    ...
    skills: [
        'Java 8', 'React', 'ReactJS', 'Express', 'NodeJS',
        'MySQL', 'MongoDB', 'AWS', 'Python', 'Rest API',
        'Open Source', 'Git', 'Github', 'Linux', 'Discord Development'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  A web developer by day and professional procrastinator by
                  night. I love coding almost as much as I love finding creative
                  ways to avoid it. My brain occasionally takes extended coffee
                  breaks without my permission, leaving me staring at my screen
                  like a cat watching a laser pointer. But hey, when my neurons
                  decide to fire, I make the web a more interesting place, one
                  quirky line of code at a time!
                </p>
              </div>
